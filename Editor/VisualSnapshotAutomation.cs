...
namespace Hackerzhuli.Code.Editor
{
    ...
    internal static class VisualSnapshotAutomation
    {
        ...
        private static bool TryResolveCamera(string requested, out Camera camera, out string errorCode,
            out string error)
        {
            return VisualSnapshotUtility.TryResolveCamera(requested, out camera, out errorCode, out error);
        }
        ...
        {
            return VisualSnapshotUtility.ComputePixelsPerUnit(camera);
        }
        ...
        {
            return VisualSnapshotUtility.TryProjectBounds(bounds, worldToCamera, projection, pixelRect,
                screenHeight, nearClip, out rect, out eyeDepthNear, out eyeDepthFar);
        }
        ...
        {
            return VisualSnapshotUtility.ToPixelRect(rect);
        }
        ...
        {
            return VisualSnapshotUtility.Intersect(first, second);
        }
